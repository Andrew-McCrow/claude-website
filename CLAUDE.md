...
When the user provides a reference website or optionally some CSS classes or style notes:

1. **Generate** a single `index.html` file using Tailwind CSS (via CDN) that mirrors the webiste shared. Include all content inline — no external files unless requested.
...
3. **Compare** your screenshot against the reference website. Check for mismatches in:
